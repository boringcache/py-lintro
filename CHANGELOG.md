...
- **deps**: update ghcr.io/lgtm-hq/py-lintro docker tag to 0.122.0 (minor) (#2127)
  (1bb3c13)
- **deps**: update dependency golang to 1.26.7 (patch) (#2125) (7af5525)

### Fixed

- **deps**: update dependency @lgtm-hq/turbo-themes to 0.41.19 (patch) (#2128) (5ec73c7)

## [0.123.1] - 2026-08-19

### Fixed

- **deps**: update dependency @lgtm-hq/turbo-themes to 0.41.17 (patch) (#2124) (b6bcf26)
...
- **ai**: run the AI review on every PR without a paths filter (#1904) (304bb38)

### Fixed

- **ci**: raise AI review limits so large-diff reviews can complete (258e55b)
...
- **mcp**: add check and format toolkit with structured findings (e4d2abf)
